 ...
 * {@link ShowExpenses.OnFragmentInteractionListener} interface
...
public class ShowExpenses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(view.findViewById(R.id.expensefragmentLayout)!=null){
            Bundle bundle = new Bundle();
            bundle.putString("DDITEMS", "daily");
            ExpandableListFragment fragment = new ExpandableListFragment();
            fragment.setArguments(bundle);
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.expensefragmentLayout, fragment).commit();
        }
        return  view;
    }
